...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("kagonmacoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "kagonmacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seedkagonmacoin", "seed.kagonmacoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testseedkagonmacoin", "testseed.kagonmacoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. kagonmacoin is probably already running."), addrBind.ToString().c_str());
        else
