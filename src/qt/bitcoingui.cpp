 ...
 * The kagonmacoin developers 2011-2018
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("kagonmacoin") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/kagonmacoin"));
    setWindowIcon(QIcon(":icons/kagonmacoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a kagonmacoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/kagonmacoin"), tr("&About kagonmacoin"), this);
    aboutAction->setStatusTip(tr("Show information about kagonmacoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for kagonmacoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/kagonmacoin"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your kagonmacoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified kagonmacoin addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/kagonmacoin"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://kagonmacoin.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/kagonmacoin"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.kagonmacoin.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/kagonmacoin_testnet"));
            setWindowIcon(QIcon(":icons/kagonmacoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/kagonmacoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("kagonmacoin client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://kagonmacoin.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.kagonmacoin.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to kagonmacoin network", "", count));
}
...
{
    QString strTitle = tr("kagonmacoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid kagonmacoin address or malformed URI parameters."),
