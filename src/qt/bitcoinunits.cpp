...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("JPKC");
    case mBTC: return QString("mJPKC");
    case uBTC: return QString::fromUtf8("μJPKC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("kagonmacoins");
    case mBTC: return QString("Milli-kagonmacoins (1 / 1,000)");
    case uBTC: return QString("Micro-kagonmacoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
