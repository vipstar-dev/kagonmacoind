...
static const int STAKE_MIN_AGE = 60 * 60 * 12; // minimum age for coin age
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // stake age of full weight
/** Maximum number of script-checking threads allowed */
static const int MAX_SCRIPTCHECK_THREADS = 16;

static const int PROOF_OF_WORK_PREMINED_BLOCKS = 2000;////PREMINED PoW
static const int PROOF_OF_WORK_BLOCKS = 10000;////PoW Limit
